...
import Employee.form.Form_Sample;
...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        getContentPane().setBackground(new Color(50, 50, 50));  // 63, 109, 217
        MenuEvent event = new MenuEvent() {
            ...
            public void menuSelected(int index) {
                if (index == 0) {
                    ...
                    showForm(new Form_Sample(index + ""));
                }
            }
        };
        menu.initMenu(event);
    ...
    private void initComponents() {
        ...
        menu = new Employee.component.Menu();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(1023, 599));
    ...
    private Employee.component.Menu menu;
