...
public class CellAction extends TableCustomCell {
        ...
        cmdEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (data.isEditing()) {
                    ...
                    cmdEdit.setIcon(new ImageIcon(getClass().getResource("/Employee/icon/edit.png")));
                } else {
                    table.editRowAt(row);
                    cmdEdit.setIcon(new ImageIcon(getClass().getResource("/Employee/icon/cancel.png")));
                }
            }
        });
    ...
    private void initComponents() {
        ...
        cmdEdit = new Employee.swing.Button();
        cmdDelete = new Employee.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Employee/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Employee/icon/delete.png"))); // NOI18N
    ...
    private Employee.swing.Button cmdEdit;
